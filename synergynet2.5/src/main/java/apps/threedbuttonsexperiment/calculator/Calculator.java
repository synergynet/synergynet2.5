...
public abstract class Calculator extends Node {
	...
	protected void init(){
		...
		//row 1
		buttonNode0 = new ButtonNode("0"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/button0.png")
				, ThreeDManipulation.class.getResource("calculator/highlightedbutton0.png"));
		...
		buttonNodeDot = new ButtonNode("."+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/buttondot.png"), ThreeDManipulation.class.getResource("calculator/highlightedbuttondot.png"));
		...
		buttonNode1 = new ButtonNode("1"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/button1.png"), ThreeDManipulation.class.getResource("calculator/highlightedbutton1.png"));
		...
		buttonNode2 = new ButtonNode("2"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/button2.png"), ThreeDManipulation.class.getResource("calculator/highlightedbutton2.png"));
		...
		buttonNode3 = new ButtonNode("3"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/button3.png"), ThreeDManipulation.class.getResource("calculator/highlightedbutton3.png"));
		...
		//row 3	
		buttonNode4 = new ButtonNode("4"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/button4.png"), ThreeDManipulation.class.getResource("calculator/highlightedbutton4.png"));
		...
		buttonNode5 = new ButtonNode("5"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/button5.png"), ThreeDManipulation.class.getResource("calculator/highlightedbutton5.png"));
		...
		buttonNode6 = new ButtonNode("6"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/button6.png"), ThreeDManipulation.class.getResource("calculator/highlightedbutton6.png"));
		...
		//row 4	
		buttonNode7 = new ButtonNode("7"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/button7.png"), ThreeDManipulation.class.getResource("calculator/highlightedbutton7.png"));
		...
		buttonNode8 = new ButtonNode("8"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/button8.png"), ThreeDManipulation.class.getResource("calculator/highlightedbutton8.png"));
		...
		buttonNode9 = new ButtonNode("9"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/button9.png"), ThreeDManipulation.class.getResource("calculator/highlightedbutton9.png"));
		...
		this.attachChild(buttonNode9);
		 ...
		 buttonNodeDelete = new ButtonNode("remove"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/buttondelete.png"), ThreeDManipulation.class.getResource("calculator/highlightedbuttondelete.png"));
		...
		buttonNodePlus = new ButtonNode("+"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/buttonplus.png"), ThreeDManipulation.class.getResource("calculator/highlightedbuttonplus.png"));
		...
		buttonNodeSubstract = new ButtonNode("-"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/buttonsubstract.png"), ThreeDManipulation.class.getResource("calculator/highlightedbuttonsubstract.png"));
		...
		buttonNodeResult = new ButtonNode("Submit"+name, buttonWidth+horizontalSpace/2, buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/buttonOK.png"), ThreeDManipulation.class.getResource("calculator/highlightedbuttonOK.png"));
		...
		/**
		 ButtonNode buttonNodePlus = new ButtonNode("+"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/buttonplus.png"), ThreeDManipulation.class.getResource("calculator/highlightedbuttonplus.png"));
		...
		ButtonNode buttonNodeSubstract = new ButtonNode("-"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/buttonsubstract.png"), ThreeDManipulation.class.getResource("calculator/highlightedbuttonsubstract.png"));
		...
		ButtonNode buttonNodeResult = new ButtonNode("="+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/buttonresult.png"), ThreeDManipulation.class.getResource("calculator/highlightedbuttonresult.png"));
		...
		ButtonNode buttonNodeMultiply = new ButtonNode("*"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/buttonmultiply.png"), ThreeDManipulation.class.getResource("calculator/highlightedbuttonmulitply.png"));
		...
		ButtonNode buttonNodeDivide = new ButtonNode("/"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, ThreeDManipulation.class.getResource("calculator/buttondivide.png"), ThreeDManipulation.class.getResource("calculator/highlightedbuttondivide.png"));
