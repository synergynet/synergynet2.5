...
public class TwoDCalculator {
	...
	public TwoDCalculator(ContentSystem contentSystem,
			TextLabel targetNumberLabel, DateTextWritter logWritter) {
	...
	protected void init() {
		...
		this.calculatorFrame = (Window) contentSystem
		...
		displayer = new TwoDDisplayNode("2D displayer", width * 0.85f,
				(length * 6) / 30);
		displayer.setLocalLocation(0, ((8.5f * verticalSpace)
				+ (4 * buttonLength) + (buttonLength / 2))
				- (length / 2));
		displayer.setText("");
		displayer.getDisplayQuad().setZOrder(Integer.MAX_VALUE);
		displayer.getDisplayQuad().updateGeometricState(0f, false);
		((Node) calculatorFrame.getImplementationObject())
				.attachChild(displayer.getDisplayQuad());
		
		final Frame buttonNode0 = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNode0.setLocalLocation(
				((2 * horizontalSpace) + (buttonWidth / 2)) - (width / 2),
				((2 * verticalSpace) + (buttonLength / 2)) - (length / 2), 0);
		...
		buttonNode0.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode0, "0",
			...
			public void cursorReleased(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode0, "0",
						(int) buttonWidth, false);
			}
			
		});

		final Frame buttonNodeDot = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNodeDot.setLocalLocation(
		...
		ButtonRenderer.RenderButton(buttonNodeDot, ".", (int) buttonWidth,
				false);
		...
		buttonNodeDot.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNodeDot, ".",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNode1 = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNode1.setLocalLocation(
				((2 * horizontalSpace) + (buttonWidth / 2)) - (width / 2),
		...
		buttonNode1.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode1, "1",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNode2 = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNode2.setLocalLocation(
				((3 * horizontalSpace) + buttonWidth + (buttonWidth / 2))
						- (width / 2),
				((3 * verticalSpace) + buttonLength + (buttonLength / 2))
						- (length / 2), 0);
		...
		buttonNode2.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode2, "2",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNode3 = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNode3.setLocalLocation(
				((4 * horizontalSpace) + (2 * buttonWidth) + (buttonWidth / 2))
						- (width / 2),
				((3 * verticalSpace) + buttonLength + (buttonLength / 2))
						- (length / 2), 0);
		...
		buttonNode3.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode3, "3",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNode4 = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNode4.setLocalLocation(
				((2 * horizontalSpace) + (buttonWidth / 2)) - (width / 2),
		...
		buttonNode4.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode4, "4",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNode5 = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNode5.setLocalLocation(
				((3 * horizontalSpace) + buttonWidth + (buttonWidth / 2))
		...
		buttonNode5.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode5, "5",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNode6 = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNode6.setLocalLocation(
				((4 * horizontalSpace) + (2 * buttonWidth) + (buttonWidth / 2))
						- (width / 2), ((4 * verticalSpace)
						+ (2 * buttonLength) + (buttonLength / 2))
						- (length / 2), 0);
		...
		buttonNode6.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode6, "6",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNode7 = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNode7.setLocalLocation(
				((2 * horizontalSpace) + (buttonWidth / 2)) - (width / 2),
		...
		buttonNode7.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode7, "7",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNode8 = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNode8.setLocalLocation(
				((3 * horizontalSpace) + buttonWidth + (buttonWidth / 2))
		...
		buttonNode8.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode8, "8",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNode9 = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNode9.setLocalLocation(
				((4 * horizontalSpace) + (2 * buttonWidth) + (buttonWidth / 2))
						- (width / 2), ((5 * verticalSpace)
						+ (3 * buttonLength) + (buttonLength / 2))
						- (length / 2), 0);
		...
		buttonNode9.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNode9, "9",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNodeDelete = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNodeDelete.setLocalLocation(((5 * horizontalSpace)
		...
		ButtonRenderer.RenderButton(buttonNodeDelete, "d", (int) buttonWidth,
				false);
		...
		buttonNodeDelete.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNodeDelete, "d",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNodePlus = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNodePlus.setLocalLocation(((5 * horizontalSpace)
				+ (3 * buttonWidth) + (buttonWidth / 2))
				- (width / 2),
				((4 * verticalSpace) + (2 * buttonLength) + (buttonLength / 2))
						- (length / 2), 0);
		...
		ButtonRenderer.RenderButton(buttonNodePlus, "+", (int) buttonWidth,
				false);
		...
		buttonNodePlus.addItemListener(new ItemEventAdapter() {
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				ButtonRenderer.RenderButton(buttonNodePlus, "+",
						(int) buttonWidth, true);
			}
		...
		final Frame buttonNodeSubstract = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNodeSubstract.setLocalLocation(((5 * horizontalSpace)
				+ (3 * buttonWidth) + (buttonWidth / 2))
				- (width / 2),
				((3 * verticalSpace) + buttonLength + (buttonLength / 2))
						- (length / 2), 0);
		...
		ButtonRenderer.RenderButton(buttonNodeSubstract, "-",
				(int) buttonWidth, false);
		...
		final Frame buttonNodeResult = (Frame) contentSystem
				.createContentItem(Frame.class);
		buttonNodeResult.setLocalLocation(((4 * horizontalSpace)
				+ (2.58f * buttonWidth) + (buttonWidth / 2))
				- (width / 2), ((2 * verticalSpace) + (buttonLength / 2))
				- (length / 2), 0);
		buttonNodeResult.setWidth((int) ((this.buttonWidth * 2)
				+ horizontalSpace + 1f));
		buttonNodeResult.setHeight((int) this.buttonLength);
		ButtonRenderer.RenderButton(buttonNodeResult, "s",
				(int) this.buttonWidth, false);
