...
public class TrialLog implements LogListener {
	 ...
	 *            the log writter
	 */
	public TrialLog(String targetString, long startTime,
	...
	public void deleteKeyPressed() {
		...
		inputHistory.add(new KeyPressRecord(currentKeyPressTime, "D",
	 ...
	 * (non-Javadoc)
	 * @see
	 * apps.threedbuttonsexperiment.logger.LogListener#keyPressed(java.lang.
	 * String)
	 */
	@Override
	public void keyPressed(String key) {
		...
		inputString.add(new KeyPressRecord(currentKeyPressTime, key,
				this.lastKeyPressTime));
		inputHistory.add(new KeyPressRecord(currentKeyPressTime, key,
				this.lastKeyPressTime));

		System.out.println("Key is: " + key + ", time is: "
				+ inputString.get(inputString.size() - 1).getPressTime());
		System.out.println("slot is: " + key + ", slot is: "
				+ inputString.get(inputString.size() - 1).getDurationTime());
		System.out.print("input String: ");
	...
	public void submitKeyPressed() {
		...
		logWritter.addRecord(targetString, input, result,
				this.effectiveDuration, this.numberOfCorrection);
