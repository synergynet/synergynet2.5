...
public class CoolCalculatorNode extends Node {
	...
	protected void init(){
		...
		ControllerBodyNode bn = new ControllerBodyNode("Body Node"+this.name, width/2, length/2, height/2, 0.1f, DataResources.class.getResource("diamondranking/imagetest/image/body.png"));	
		this.attachChild(bn);
		...
		final DisplayNode dn = new DisplayNode("Display", width*0.9f/2, (float)(length*7/60), height*1.5f, 0.1f, DataResources.class.getResource("diamondranking/imagetest/image/body.png"));
		dn.setLocalTranslation(0, 8.5f*verticalSpace+4*buttonLength+buttonLength/2-length/2, bn.getLocalTranslation().z);
		this.attachChild(dn);
		dn.showCoolMode();
		...
		//row 1
		ButtonNode buttonNode0 = new ButtonNode("0"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/button0.png"));
		...
		ButtonNode buttonNodeDot = new ButtonNode("."+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/buttondot.png"));
		...
		ButtonNode buttonNodeResult = new ButtonNode("="+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonresult.png"));
		...
		ButtonNode buttonNodeDivide = new ButtonNode("/"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/buttondivide.png"));
		...
		ButtonNode buttonNode1 = new ButtonNode("1"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/button1.png"));
		...
		ButtonNode buttonNode2 = new ButtonNode("2"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/button2.png"));
		...
		ButtonNode buttonNode3 = new ButtonNode("3"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/button3.png"));
		...
		ButtonNode buttonNodeMultiply = new ButtonNode("*"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonmultiply.png"));
		...
		ButtonNode buttonNode4 = new ButtonNode("4"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/button4.png"));
		...
		ButtonNode buttonNode5 = new ButtonNode("5"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/button5.png"));
		...
		ButtonNode buttonNode6 = new ButtonNode("6"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/button6.png"));
		...
		ButtonNode buttonNodeSubstract = new ButtonNode("-"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonsubstract.png"));
		...
		ButtonNode buttonNode7 = new ButtonNode("7"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f,
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/button7.png"));
		...
		ButtonNode buttonNode8 = new ButtonNode("8"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/button8.png"));
		...
		ButtonNode buttonNode9 = new ButtonNode("9"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/button9.png"));
		...
		ButtonNode buttonNodePlus = new ButtonNode("+"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonBg.png"), 
				DataResources.class.getResource("diamondranking/imagetest/image/buttonplus.png"));
