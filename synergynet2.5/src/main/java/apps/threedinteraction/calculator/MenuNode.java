...
public class MenuNode extends Node {
	...
	protected void init() {
		...
		EdittableButtonNode buttonNode0 = new EdittableButtonNode(
				"0" + name,
				buttonWidth / 2,
				buttonLength / 2,
				buttonHeight / 2,
				...
				"editable button");
		buttonNode0.setLocalTranslation(0,
		...
		EdittableButtonNode buttonNode1 = new EdittableButtonNode(
				"1" + name,
				buttonWidth / 2,
				buttonLength / 2,
				buttonHeight / 2,
				...
				DataResources.class
						.getResource("diamondranking/imagetest/image/buttonBg.png"),
				"editable button");
		buttonNode1.setLocalTranslation(0,
		...
		EdittableButtonNode buttonNode2 = new EdittableButtonNode(
				"2" + name,
				buttonWidth / 2,
				buttonLength / 2,
				buttonHeight / 2,
				...
				DataResources.class
						.getResource("diamondranking/imagetest/image/buttonBg.png"),
				"editable button");
		buttonNode2.setLocalTranslation(0, ((4 * verticalSpace)
