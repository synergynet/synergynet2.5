...
public class CalculatorNode extends Node {
	...
	protected void init(){
		...
		final DisplayNode dn = new DisplayNode("Display"+name, width*0.9f/2, (float)(length*7/60), height*1.5f, 0.1f, 
				ThreeDManipulation.class.getResource("calculator/body.png"));
		...
		ButtonNode buttonNodeDot = new ButtonNode("."+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				ThreeDManipulation.class.getResource("calculator/buttonBg.png"), ThreeDManipulation.class.getResource("calculator/buttondot.png"));
		...
		ButtonNode buttonNodeResult = new ButtonNode("="+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				ThreeDManipulation.class.getResource("calculator/buttonBg.png"), 
				ThreeDManipulation.class.getResource("calculator/buttonresult.png"));
		...
		buttonNodeResult.addKeyListener(new KeyListener(){
			@Override
			public void keyPressed(String key) {
				if (leftNumber.equals("")) {clear(); return;}
				if (rightNumber.equals("")) {clear(); return;}
				if (operator.equals("")) {clear(); return;}
		...
		ButtonNode buttonNodeDivide = new ButtonNode("/"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				ThreeDManipulation.class.getResource("calculator/buttonBg.png"), 
				ThreeDManipulation.class.getResource("calculator/buttondivide.png"));
		...
		ButtonNode buttonNodeMultiply = new ButtonNode("*"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				ThreeDManipulation.class.getResource("calculator/buttonBg.png"), 
				ThreeDManipulation.class.getResource("calculator/buttonmultiply.png"));
		...
		ButtonNode buttonNodeSubstract = new ButtonNode("-"+name, buttonWidth/2,buttonLength/2, buttonHeight/2, 0.05f, 
				ThreeDManipulation.class.getResource("calculator/buttonBg.png"), 
				ThreeDManipulation.class.getResource("calculator/buttonsubstract.png"));
