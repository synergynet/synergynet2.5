...
public class TargetObjectCollection {
	...
	private static final ColorRGBA AMBIENT_COLORED_COLOR = new ColorRGBA(0.8f,
			0.8f, 0.2f, 1.0f);
	
	/** The Constant AMBIENT_GRAY_COLOR. */
	@SuppressWarnings("unused")
	private static final ColorRGBA AMBIENT_GRAY_COLOR = new ColorRGBA(0.7f,
			0.7f, 0.7f, 1.0f);
	
	/** The Constant DIFFUSE_COLOR. */
	private static final ColorRGBA DIFFUSE_COLOR = new ColorRGBA(0.1f, 0.5f,
			0.8f, 1.0f);
	
	/** The Constant EMISSIVE_COLOR. */
	@SuppressWarnings("unused")
	private static final ColorRGBA EMISSIVE_COLOR = new ColorRGBA(0.3f, 0.2f,
			0.2f, 0.0f);
	...
	public TargetObjectCollection(Node worldNode, DirectionalShadowMapPass pass) {
		...
		texture = TextureManager.loadTexture(
				ThreeDManipulation.class.getResource("texture.jpg"),
