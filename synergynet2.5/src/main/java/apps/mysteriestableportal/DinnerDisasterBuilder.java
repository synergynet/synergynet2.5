...
public class DinnerDisasterBuilder {
	...
	public List<ContentItem> build(ContentSystem contentSystem){
		...
		MultiLineTextLabel l1 = (MultiLineTextLabel) contentSystem.createContentItem(MultiLineTextLabel.class);
		l1.setId("IDD1");
		...
		MultiLineTextLabel l2 = (MultiLineTextLabel) contentSystem.createContentItem(MultiLineTextLabel.class);
		l2.setId("IDD2");
		...
		MultiLineTextLabel l3 = (MultiLineTextLabel) contentSystem.createContentItem(MultiLineTextLabel.class);
		l3.setId("IDD3");
		...
		MultiLineTextLabel l4 = (MultiLineTextLabel) contentSystem.createContentItem(MultiLineTextLabel.class);
		l4.setId("IDD4");
		...
		MultiLineTextLabel l5 = (MultiLineTextLabel) contentSystem.createContentItem(MultiLineTextLabel.class);
		l5.setId("IDD5");
		...
		MultiLineTextLabel l6 = (MultiLineTextLabel) contentSystem.createContentItem(MultiLineTextLabel.class);
		l6.setId("IDD6");
		...
		frame8.setId("IDD8");
		frame8.drawImage(MysteriesPortalClientApp.class.getResource("tanya.png"));
		frame8.centerItem();
		...
		frame9.setId("IDD9");
		frame9.drawImage(MysteriesPortalClientApp.class.getResource("grace.png"));
		frame9.centerItem();
		...
		frame10.setId("IDD10");
		frame10.drawImage(MysteriesPortalClientApp.class.getResource("mike.png"));
		frame10.centerItem();
		...
		frame11.setId("IDD11");
		frame11.drawImage(MysteriesPortalClientApp.class.getResource("ruby.png"));
		frame11.centerItem();
		...
		frame13.setId("IDD13");
		frame13.drawImage(MysteriesPortalClientApp.class.getResource("burger.png"));
		frame13.centerItem();
		...
		frame14.setId("IDD14");
		frame14.drawImage(MysteriesPortalClientApp.class.getResource("fries.png"));
		frame14.centerItem();
		...
		frame15.setId("IDD15");
		frame15.drawImage(MysteriesPortalClientApp.class.getResource("salad.png"));
		frame15.centerItem();
		...
		frame16.setId("IDD16");
		frame16.drawImage(MysteriesPortalClientApp.class.getResource("yogurt.png"));
		frame16.centerItem();
		...
		frame17.setId("IDD17");
		frame17.drawImage(MysteriesPortalClientApp.class.getResource("pizza.png"));
		frame17.centerItem();
		...
		MultiLineTextLabel l12 = (MultiLineTextLabel) contentSystem.createContentItem(MultiLineTextLabel.class);
		l12.setId("IDDTitle");
