	...
	public void onActivate() {
		RapidNetworkManager.addNetworkedContentListener(new NetworkedContentListener(){
			...
			public void tableConnected() {
				...
				contentSystem = ContentSystem.getContentSystemForSynergyNetApp(MysteriesPortalClientApp.this);
				...
				RapidNetworkManager.registerMessageProcessor(clientProcessor);
				try {
					RapidNetworkManager.getTableCommsClientService().sendMessage(new AnnounceTableMessage(ControllerApp.class));
				} catch (IOException e) {
