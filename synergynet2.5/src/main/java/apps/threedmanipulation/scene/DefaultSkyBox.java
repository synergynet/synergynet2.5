...
public class DefaultSkyBox extends Skybox {
	...
	public DefaultSkyBox(String name, float size) {
		...
		Texture north = TextureManager.loadTexture(
				ThreeDManipulation.class.getResource("north.jpg"),
				Texture.MinificationFilter.BilinearNearestMipMap,
				Texture.MagnificationFilter.Bilinear);
		Texture south = TextureManager.loadTexture(
				ThreeDManipulation.class.getResource("south.jpg"),
				Texture.MinificationFilter.BilinearNearestMipMap,
				Texture.MagnificationFilter.Bilinear);
		Texture east = TextureManager.loadTexture(
				ThreeDManipulation.class.getResource("east.jpg"),
				Texture.MinificationFilter.BilinearNearestMipMap,
				Texture.MagnificationFilter.Bilinear);
		Texture west = TextureManager.loadTexture(
				ThreeDManipulation.class.getResource("west.jpg"),
				Texture.MinificationFilter.BilinearNearestMipMap,
				Texture.MagnificationFilter.Bilinear);
		Texture up = TextureManager.loadTexture(
				ThreeDManipulation.class.getResource("top.jpg"),
				Texture.MinificationFilter.BilinearNearestMipMap,
				Texture.MagnificationFilter.Bilinear);
		Texture down = TextureManager.loadTexture(
				ThreeDManipulation.class.getResource("bottom.jpg"),
				Texture.MinificationFilter.BilinearNearestMipMap,
				Texture.MagnificationFilter.Bilinear);
