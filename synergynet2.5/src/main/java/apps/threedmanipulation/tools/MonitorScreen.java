...
public class MonitorScreen extends Node{
	...
	public void buildScreenFrame(){
		...
		texture  = TextureManager.loadTexture(ThreeDManipulation.class.getResource(
		    	"camerascreen"+skinColor+".png"),  Texture.MinificationFilter.Trilinear, Texture.MagnificationFilter.Bilinear);
	...
	public void buildbuttons(){
		...
		zoomInLabel.addItemListener(new ItemEventAdapter(){
			...
			public void cursorPressed(ContentItem item, long id, float x,
				...
				zoomInLabel.setImageInfo(ThreeDManipulation.class.getResource("zoominbutton.png"));
				zoomIn = true;
			}
		...
		zoomOutLabel.setImageInfo(ThreeDManipulation.class.getResource("zoomoutbuttonnormal.png"));
		zoomOutLabel.addItemListener(new ItemEventAdapter(){
			@Override
			public void cursorPressed(ContentItem item, long id, float x,
					float y, float pressure) {
				super.cursorPressed(item, id, x, y, pressure);
				zoomOutLabel.setImageInfo(ThreeDManipulation.class.getResource("zoomoutbutton.png"));
				zoomOut = true;
			}
		...
		zInLabel.setImageInfo(ThreeDManipulation.class.getResource("zinbuttonnormal.png"));
		zInLabel.addItemListener(new ItemEventAdapter(){
			@Override
			public void cursorPressed(ContentItem item, long id, float x,
					float y, float pressure) {
				super.cursorPressed(item, id, x, y, pressure);
				zInLabel.setImageInfo(ThreeDManipulation.class.getResource("zinbutton.png"));
				moveIn = true;
			}
		...
		zOutLabel.setImageInfo(ThreeDManipulation.class.getResource("zoutbuttonnormal.png"));
		zOutLabel.addItemListener(new ItemEventAdapter(){
			@Override
			public void cursorPressed(ContentItem item, long id, float x,
					float y, float pressure) {
				super.cursorPressed(item, id, x, y, pressure);
				zOutLabel.setImageInfo(ThreeDManipulation.class.getResource("zioutbutton.png"));
				moveOut = true;
			}
		...
		modeLabel.setImageInfo(ThreeDManipulation.class.getResource("manipulationbutton.png"));
		modeLabel.addItemListener(new ItemEventAdapter(){
			...
			public void cursorClicked(ContentItem item, long id, float x,
				...
				if (mode.equals(OjbectManipulation.MODE_CAMERAMANIPULATION)){
					mode = OjbectManipulation.MODE_OBJECTMANIPULATION;
					telescopeManipulateOjbect.setMode(OjbectManipulation.MODE_OBJECTMANIPULATION);
					modeLabel.setImageInfo(ThreeDManipulation.class.getResource("manipulationbuttonnormal.png"));
				}
				else{
					mode = OjbectManipulation.MODE_CAMERAMANIPULATION;
					telescopeManipulateOjbect.setMode(OjbectManipulation.MODE_CAMERAMANIPULATION);
