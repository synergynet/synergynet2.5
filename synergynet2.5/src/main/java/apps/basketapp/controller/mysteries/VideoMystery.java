...
public class VideoMystery {
	...
	public List<ContentItem> getMystery(ContentSystem contentSystem){
		...
		video1.setMediaURL(BasketAppResources.class.getResource("Moralreasoning1.avi"));
		video1.centerItem();
		items.add(video1);
		...
		video2.setMediaURL(BasketAppResources.class.getResource("Moralreasoning2.avi"));
		video2.centerItem();
		items.add(video2);
		...
		video3.setMediaURL(BasketAppResources.class.getResource("Moralreasoning3.avi"));
		video3.centerItem();
		items.add(video3);
		...
		MediaPlayer video4 = (MediaPlayer) contentSystem.createContentItem(MediaPlayer.class);
		video4.setMediaURL(BasketAppResources.class.getResource("Moralreasoning4.avi"));
		video4.centerItem();
		items.add(video4);
		...
		video5.setMediaURL(BasketAppResources.class.getResource("Moralreasoning5.avi"));
		video5.centerItem();
		items.add(video5);
