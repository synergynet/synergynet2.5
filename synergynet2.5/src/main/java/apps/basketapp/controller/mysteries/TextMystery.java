...
public class TextMystery {
		...
		public List<ContentItem> getMystery(ContentSystem contentSystem){
			...
			LightImageLabel blog = (LightImageLabel) contentSystem.createContentItem(LightImageLabel.class);
			...
			LightImageLabel hw = (LightImageLabel) contentSystem.createContentItem(LightImageLabel.class);
			...
			LightImageLabel let01 = (LightImageLabel) contentSystem.createContentItem(LightImageLabel.class);
			...
			LightImageLabel let02 = (LightImageLabel) contentSystem.createContentItem(LightImageLabel.class);
			...
			LightImageLabel let03 = (LightImageLabel) contentSystem.createContentItem(LightImageLabel.class);
