...
public class RayTracerEngine implements ImageProducer, Runnable {
	 ...
	 * (non-Javadoc)
	 * @see
	 * java.awt.image.ImageProducer#requestTopDownLeftRightResend(java.awt.image
	 * .ImageConsumer)
	 */
	public void requestTopDownLeftRightResend(ImageConsumer ic) {
		ic.setHints(ImageConsumer.TOPDOWNLEFTRIGHT);
		ic.setPixels(0, 0, width, lines_produced, ColorModel.getRGBdefault(),
				pixels.pixels, 0, width);
		...
		for (int y = 0; y < height; y++) {
			...
			synchronized (this) {
				...
				if (consumer != null) {
					...
					consumer.setPixels(0, // starting x
