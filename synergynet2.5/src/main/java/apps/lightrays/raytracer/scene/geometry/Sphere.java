...
public class Sphere extends SceneObject {
	 ...
	 * (non-Javadoc)
	 * @see
	 * apps.lightrays.raytracer.scene.SceneObject#createShader(apps.lightrays
	 * .raytracer.scene.Ray)
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * apps.lightrays.raytracer.scene.SceneObject#getNormal(apps.lightrays.raytracer
	 * .scene.Point)
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * apps.lightrays.raytracer.scene.SceneObject#intersect(apps.lightrays.raytracer
	 * .scene.Ray)
	 */
	...
	public String toString() {
		return this.getClass().getName() + radius + "@" + center
				+ this.optic_properties;
	}
