...
public class PositionDialog extends JDialog implements ActionListener{
	...
	public PositionDialog(){
		...
		}else if(DesktopClient.currentPosition.equals(DesktopClient.Position.SOUTH)){
	...
	public void actionPerformed(ActionEvent e) {
    	...
    	Preferences.userRoot().put("client_position", DesktopClient.currentPosition.toString());
	}
}
