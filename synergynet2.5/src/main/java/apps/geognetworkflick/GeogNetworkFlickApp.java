...
public class GeogNetworkFlickApp extends DefaultSynergyNetApp {
	...
	/** The blue table. */
	String[] blueTable = { "brasil_flag.jpg", "brasil_llama.jpg",
			"brasil_map.jpg", "brasil_riodejaneirocorcovado.jpeg",
	...
	/** The green table. */
	String[] greenTable = { "china_ panda.jpg", "china_flag.jpg",
			"china_great_wall.jpg", "china_map.gif", };
	...
	/** The red table. */
	String[] redTable = { "australia_flag.jpg", "australia_kangaroo.jpg",
			"australia_map.jpg", "australia_Sydney.jpg", };

	/** The text images. */
	String[] textImages = { "text_beijing.jpg", "text_brasilia.jpg",
			"text_canberra.jpg", "text_newdelhi.jpg" };
	
	/** The transfer controller. */
	protected TransferController transferController;
	
	/** The yellow table. */
	String[] yellowTable = { "india_map.jpg", "india_Taj-Mahal.jpg",
			"india_tiger.jpg", "india-flag.jpg",
	...
	private void addImage(URL resource) {
		...
		ImageTextLabel mlt3 = (ImageTextLabel) contentSystem
					...
					GameTaskQueueManager.getManager().update(
							new Callable<Void>() {
								...
								public Void call() throws Exception {
									addImage(GeogNetworkFlickApp.class
											.getResource(img));
									return null;
								}
							});
		...
		try {
			...
			if (comms != null) {
				comms.sendMessage(new ApplicationCommsRequest(
						GeogNetworkFlickApp.class.getName()));
			}
