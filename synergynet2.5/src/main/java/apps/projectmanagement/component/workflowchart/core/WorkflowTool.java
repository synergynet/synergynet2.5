...
public class WorkflowTool {
	...
	private void init(){
		...
		topRight = (SimpleButton) contentSystem.createContentItem(SimpleButton.class);
		...
		bottomLeft = (SimpleButton) contentSystem.createContentItem(SimpleButton.class);
		...
		bottomRight = (SimpleButton) contentSystem.createContentItem(SimpleButton.class);
