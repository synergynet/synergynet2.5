...
public class ScrollBar {
	...
	/**
	 * The listener interface for receiving scroll events. The class that is
	 * interested in processing a scroll event implements this interface, and
	 * the object created with that class is registered with a component using
	 * the component's <code>addScrollListener<code> method. When
	 ...
	 *            the direction
	 */
	public ScrollBar(int length, int heigth, int contentLength,
			ContentSystem contentSystem, Direction direction) {
		this.length = length;
		this.heigth = heigth;
	...
	protected void init() {
		...
		Spatial handleBarSpatial = (Spatial) (handleBar
				.getImplementationObject());
		ScrollBarControl scrollBarControl = new ScrollBarControl(
				handleBarSpatial, handleBarSpatial, length, barLength,
				contentLength, barX, direction);
