...
public class InputBox {
	...
	private static final Logger log = Logger
			.getLogger(InputBox.class.getName());
	...
	protected void updateKeyboardLocation() {
		...
		Spatial inputBoxSpatial = ((Spatial) noteLabel
				.getImplementationObject());
		Vector3f worldLocation = new Vector3f();
		inputBoxSpatial.getParent().localToWorld(
				inputBoxSpatial.getLocalTranslation(), worldLocation);
	...
	private void updateLine() {
		if ((line != null) && (keyboard != null)) {
			...
			line.setSourceLocation(new Location(worldLocation.x,
					worldLocation.y, 0));
			line.setTargetLocation(keyboard.getLocalLocation());
		}
	}
