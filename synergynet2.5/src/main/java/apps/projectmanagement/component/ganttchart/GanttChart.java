...
public class GanttChart extends Node {
	...
	protected void buildButtons(){
		...
		addbutton.drawImage(ProjectManagementApp.class.getResource("addbutton.png"));
		...
		addbutton.addItemListener(new ItemEventAdapter(){
			...
			public void cursorDoubleClicked(ContentItem item, long id, float x,
				...
				final TaskRow row = new TaskRow(ganttChart, contentSystem, schedulePanel, taskAreaPanel, rowHeight, periodLength/5, schedulePanelOrgin);
		...
		titleBar.setImageInfo(ProjectManagementApp.class.getResource("titlebar.png"));
