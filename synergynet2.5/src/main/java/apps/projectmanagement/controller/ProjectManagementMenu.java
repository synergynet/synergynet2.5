 ...
 */
public class ProjectManagementMenu extends MenuController implements
	...
	public void createMenu() {
		...
		final SimpleButton workflow = (SimpleButton) contentSystem
		...
		final SimpleButton laborAllocation = (SimpleButton) contentSystem
				.createContentItem(SimpleButton.class);
		...
		final SimpleButton ganttChartButton = (SimpleButton) contentSystem
				.createContentItem(SimpleButton.class);
		...
		final SimpleButton exit = (SimpleButton) contentSystem
				.createContentItem(SimpleButton.class);
	...
	public void cursorPressed(MultiTouchCursorEvent event) {
		if (isInCorner(event)) {
			synchronized (cursorTiming) {
				cursorTiming.put(event.getCursorID(),
	...
	public void update(float interpolation) {
		...
		if (menuContainer.isVisible()) {
			if ((System.currentTimeMillis() - startVisibleTime) > visibleInterval) {
				menuContainer.setVisible(false);
			}
		}
