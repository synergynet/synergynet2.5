...
class HTTPConnectSocketFactory implements SocketFactory {
	 ...
	 * (non-Javadoc)
	 * @see
	 * synergynetframework.appsystem.contentsystem.items.utils.vnc.SocketFactory
	 * #createSocket(java.lang.String, int, java.applet.Applet)
	 */
	 ...
	 * @see
	 * synergynetframework.appsystem.contentsystem.items.utils.vnc.SocketFactory
	 * #createSocket(java.lang.String, int, java.lang.String[])
	 */
	public Socket createSocket(String host, int port, String[] args)
			throws IOException {
		
		return createSocket(host, port, readArg(args, "PROXYHOST1"),
