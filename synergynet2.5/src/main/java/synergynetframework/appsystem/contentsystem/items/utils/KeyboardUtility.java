...
public class KeyboardUtility {
	...
	/** The line1. */
	private int[] line1 = { KeyEvent.VK_1, KeyEvent.VK_2, KeyEvent.VK_3,
			KeyEvent.VK_4, KeyEvent.VK_5, KeyEvent.VK_6, KeyEvent.VK_7,
			KeyEvent.VK_8, KeyEvent.VK_9, KeyEvent.VK_0, KeyEvent.VK_BACK_SPACE };

	/** The line2. */
	private int[] line2 = { KeyEvent.VK_Q, KeyEvent.VK_W, KeyEvent.VK_E,
			KeyEvent.VK_R, KeyEvent.VK_T, KeyEvent.VK_Y, KeyEvent.VK_U,
			KeyEvent.VK_I, KeyEvent.VK_O, KeyEvent.VK_P, KeyEvent.VK_CAPS_LOCK };

	/** The line3. */
	private int[] line3 = { KeyEvent.VK_A, KeyEvent.VK_S, KeyEvent.VK_D,
			KeyEvent.VK_F, KeyEvent.VK_G, KeyEvent.VK_H, KeyEvent.VK_J,
			KeyEvent.VK_K, KeyEvent.VK_L, KeyEvent.VK_ENTER };

	/** The line4. */
	private int[] line4 = { KeyEvent.VK_SHIFT, KeyEvent.VK_Z, KeyEvent.VK_X,
			KeyEvent.VK_C, KeyEvent.VK_V, KeyEvent.VK_B, KeyEvent.VK_N,
	...
	public KeyboardUtility(MTKeyboard keyboard) {
		...
		for (int key : line1) {
			keys.put(new Rectangle(point.x - (separator / 2), point.y
					- (separator / 2), buttonWidth + separator, buttonHeight
					+ separator), key);
		...
		keys.put(new Rectangle(point.x - (separator / 2), point.y
				- (separator / 2), 180 + separator, buttonHeight + separator),
				line3[line3.length - 1]);
		...
		keys.put(new Rectangle(point.x - (separator / 2), point.y
				- (separator / 2), 140 + separator, buttonHeight + separator),
				line4[line4.length - 1]);

		point = fifthLineStart;
		for (int key : line5) {
			keys.put(new Rectangle(point.x - (separator / 2), point.y
					- (separator / 2), (buttonWidth + separator) * 11,
					buttonHeight + separator), key);
			point.x += buttonWidth + separator;
		}
		...
		for (Rectangle rec : keys.keySet()) {
			if (rec.contains(x, y)) {
				...
				KeyEvent keyEvent = new KeyEvent(fakeComponent,
						...
						getModifiers(), key, getKeyText(key));
				return keyEvent;
			}
		}
		return null;
