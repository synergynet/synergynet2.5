...
/**
 * The listener interface for receiving innerNoteEvent events.
 * The class that is interested in processing a innerNoteEvent
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addInnerNoteEventListener<code> method. When
